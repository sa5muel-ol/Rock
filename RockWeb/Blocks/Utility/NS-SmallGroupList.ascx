<%@ Control Language="C#" AutoEventWireup="true" CodeFile="NS-SmallGroupList.ascx.cs" Inherits="Blocks.Utility.SmallGroupList" %>
    ...
    <ContentTemplate>
        ...
        <div class="panel panel-block">
            ...
            <div class="panel-body">
                ...
                <div class="grid grid-panel">
                    ...
                    <Rock:Grid ID="gSmallGroups" runat="server" RowItemText="Group" AllowSorting="true" OnRowSelected="gSmallGroups_OnRowSelected" CssClass="js-grid-group-list" DataKeyNames="Id">
                        <Columns>
                            ...
                            <Rock:BoolField DataField="IsSystem" HeaderText="Action" SortExpression="IsSystem" />
                            <Rock:BoolField DataField="IsActive" HeaderText="Active" SortExpression="IsActiveOrder" />
                            <Rock:SecurityField TitleField="Name" />
                            <%-- <Rock:DataViewItemPicker runat="server"/> --%>
                            <Rock:DeleteField OnClick="gSmallGroups_DeleteOrArchive" />
                        </Columns>
                    </Rock:Grid>
                </div>
        ...
        <script>
            ...
            Sys.Application.add_load(function () {
                ...
                $('#<%=gSmallGroups.ClientID%>').find('a.grid-delete-button')
                    .on('click', function (e) {
